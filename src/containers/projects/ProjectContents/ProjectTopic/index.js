...
const ProjectTopic = () => {
  ...
  return (
    <div className="w-full flex flex-col lg:flex-row justify-around mt-20">
      <div className="lg:flex lg:flex-col items-center order-2 lg:order-1">
        <div className=" basis-1/2 flex justify-center">
          {currentlyData && (
            <Image src={currentlyData?.poster} width={350} alt="hiya" />
          )}
        </div>
      ...
      <div className=" lg:flex lg:flex-col items-center order-3 basis-1/2">
